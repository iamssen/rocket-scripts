    ...
    if (extend.serverSideRendering) {
        ...
        function (req, res, next) {
            if (req.url && !/\.[a-zA-Z0-9]+$/.test(req.url)) {
                if (fs_extra_1.default.pathExists(path_1.default.join(cwd, 'src', app, 'index.html'))) {
                    req.url = '/index.html';
                }
                else if (fs_extra_1.default.pathExists(path_1.default.join(cwd, 'src', app, '200.html'))) {
                    req.url = '/200.html';
                }
