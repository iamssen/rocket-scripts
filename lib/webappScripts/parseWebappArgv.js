...
function parseWebappArgv(nodeArgv) {
    ...
    return {
        ...
        appFileName: takeMinimistLatestValue_1.takeMinimistLatestValue(argv['app-file-name']) || 'main',
        vendorFileName: takeMinimistLatestValue_1.takeMinimistLatestValue(argv['vendor-file-name']) || 'vendor',
        styleFileName: takeMinimistLatestValue_1.takeMinimistLatestValue(argv['style-file-name']) || 'style',
        ...
        port: takeMinimistLatestValue_1.takeMinimistLatestValue(argv['port']) || 3100,
        serverPort: takeMinimistLatestValue_1.takeMinimistLatestValue(argv['server-port']) || 4100,
        https,
    };
}
