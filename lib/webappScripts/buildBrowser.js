...
// - [x] create html files
async function buildBrowser({ mode, output, app, cwd, serverPort, staticFileDirectories, chunkPath, publicPath, appFileName, vendorFileName, styleFileName, sizeReport, extend, zeroconfigPath, }) {
