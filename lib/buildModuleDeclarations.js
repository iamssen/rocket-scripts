...
module.exports = function ({ buildOption, appDirectory }) {
    ...
    return new Promise((resolve, reject) => {
        ...
        const { jsx, experimentalDecorators, allowJs, downlevelIteration, importHelpers, allowSyntheticDefaultImports, esModuleInterop, alwaysStrict, strictNullChecks, strictBindCallApply, strictFunctionTypes, strictPropertyInitialization, lib, } = config.compilerOptions;
