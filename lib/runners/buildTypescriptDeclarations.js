...
async function buildTypescriptDeclarations({ indexFile, name, compilerOptions, cwd, typeRoots, declarationDir }) {
    const program = typescript_1.createProgram([indexFile], {
        ...compilerOptions,
        allowJs: false,
        ...
        baseUrl: path_1.default.dirname(indexFile),
        declarationDir,
    });
