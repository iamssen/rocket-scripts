...
export async function buildTypescriptDeclarations({
  file,
  name,
  compilerOptions,
  cwd,
  typeRoots,
  declarationDir,
}: BuildTypescriptDeclarationsParams) {
  const options: CompilerOptions = {
    ...
    typeRoots: [...(compilerOptions.typeRoots || []), path.join(cwd, 'node_modules/@types'), ...typeRoots],
